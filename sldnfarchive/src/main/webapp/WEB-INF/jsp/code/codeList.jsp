		        ...
		        <main>
		            <div class="container-fluid px-4">
		            	<div class="card card-header mt-4">
		            		<form id="schCodeFrm" class="row d-block d-md-flex col-12 p-0 m-0 justify-content-between" onsubmit="javascript:return false;">
		                    ...
		                    <div class="card-body">
		                    	 <div class="row col-12 p-0 m-0 d-block d-md-flex justify-content-md-end gap-2">
		                    	 	<div class="col-auto text-end ps-0">
		                 				<input type="button" class="btn bg-warning text-bg-warning" onclick="javascript:insertCode('L');" value="상위코드 추가" />
		                 			</div>
		                 			<div class="col-auto text-end ps-0 mt-2 mt-md-0">
		                 				<input type="button" class="btn bg-warning text-bg-warning" onclick="javascript:insertCode('S');" value="하위코드 추가" />
		                 			</div>
		                 			<div class="col-auto text-end ps-0 mt-2 mt-md-0">
				                    		...
				                    		<div class="row d-block d-md-flex col-12 p-0 m-0">
		                              		...
		                              		<div class="row col-12 p-0 mx-0 mt-3 mb-0">
				                    			<div class="input-group p-0">
			                              			<label for="codeNote" class="col-4 col-md-2 p-2 text-end">비고</label>
